...
const PLATFORMS = {
  "win32-x64": {
    ...
    pkg: "tropical-bundler-win32-x64",
  ...
  "linux-x64": {
    ...
    pkg: "tropical-bundler-linux-x64-gnu",
  ...
  "darwin-x64": {
    ...
    pkg: "tropical-bundler-darwin-x64",
    bin: "tropical-bundler",
    os: ["darwin"],
    cpu: ["x64"],
  },
  "darwin-arm64": {
    ...
    pkg: "tropical-bundler-darwin-arm64",
    bin: "tropical-bundler",
    os: ["darwin"],
    cpu: ["arm64"],
  },
  "linux-arm64": {
    ...
    pkg: "tropical-bundler-linux-arm64-gnu",
    bin: "tropical-bundler",
    os: ["linux"],
    cpu: ["arm64"],
  },
